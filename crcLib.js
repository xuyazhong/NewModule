...
export default class crcLib extends React.Component {
  ...
  static calc(originString = '') {
    ...
    CRC.convertChinese = function (str) {
        ...
        console.log('convertChinese =>', str, arr);
        return arr;
    };
    CRC.filterChinese = function (str) {
        ...
        console.log('filterChinese =>', str, arr);
        return arr;
    };
    CRC.strToHex = function (hex, isFilterChinese) {
        ...
        console.log('strToHex =>', hex, "isFilterChinese =>", isFilterChinese);
        console.log('strToHex arr =>', arr);
        return arr;
    };
    ...
    return CRC.ToCCITTCRC16(originString);
  }
}
