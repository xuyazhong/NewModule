package com.xuyazhong.test.utils;

import android.os.Environment;

public class Config {
    public static final String TOKEN = "YjbWFZ2IYF365zFCNvvrwGXXAfrx8M5p1F3SrCSB:RHd0QZqvXEfu0okVfhx24K1XyEQ=:eyJzY29wZSI6ImltYWdlIiwiZGVhZGxpbmUiOjE1MjI3NTM5NTR9";
